    ...
    const create = async (data) => {
        ...
        try {
            ...
            if (result && result.sessionId) {
                localStorage.setItem('appwrite_session', JSON.stringify(result));
                ...
                try {
                    ...
                    if (loginError.response) {
                        setError(loginError.response.message);
                    } else {
                        setError(loginError.message || "Login failed after signup.");
                    }
                }
            } else {
                throw new Error("Account creation or automatic login failed.");
            }
        } catch (err) {
